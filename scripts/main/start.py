...
from scripts.character.ship import Ship
from scripts.main.settings import Settings
from scripts.game.button import Button
from scripts.game.game_controls import GameControls
...
class InitializeGame:
    def __init__(self):
        ...
        ship = Ship(screen, './assets/character/new_ship2', ai_sets)
